...
VREG_CONSUMERS(S2) = {
	...
	REGULATOR_SUPPLY("iris_vddrfa1",	"wcnss_wlan.0"),
};
VREG_CONSUMERS(S3) = {
...
struct regulator_init_data msm8064_saw_regulator_pdata_8921_s5 =
	...
	SAW_VREG_INIT(S5, "8921_s5",	       SC_MIN_VDD, SC_MAX_VDD);
struct regulator_init_data msm8064_saw_regulator_pdata_8921_s6 =
	SAW_VREG_INIT(S6, "8921_s6",	       SC_MIN_VDD, SC_MAX_VDD);

struct regulator_init_data msm8064_saw_regulator_pdata_8821_s0 =
	/*	      ID       vreg_name	min_uV  max_uV */
	SAW_VREG_INIT(8821_S0, "8821_s0",       SC_MIN_VDD, SC_MAX_VDD);
struct regulator_init_data msm8064_saw_regulator_pdata_8821_s1 =
	SAW_VREG_INIT(8821_S1, "8821_s1",       SC_MIN_VDD, SC_MAX_VDD);
...
apq8064_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_SMPS(S3, 0, 1, 1,  500000, MEM_DIG_MAX_VDD, NULL, 100000, 4p80, NONE, NONE),
	...
	RPM_LDO(L24, 0, 1, 1,  750000, MEM_DIG_MAX_VDD, "8921_s1", 10000, 10000),
